...
Este trabalho tem como objetivo propor um modelo computacional para a previsão de resultados e apoio à decisão em jogos da NBA, com base em aprendizado de máquina e análise estatística avançada.
...
\end{itemize}
Ao decompor as previsões nestas quatro categorias, a matriz de confusão revela não apenas quantos erros o modelo comete, mas também de que forma ele erra, o que é crucial para o diagnóstico e aprimoramento do modelo \cite{ibm_confusion_matrix}.
...
% -----------------------------------------------------------------------
% 2.3 Técnicas de Machine Learning Aplicadas ao Esporte
% -----------------------------------------------------------------------
...
% ========================================================================
% CAPÍTULO 3: DESENVOLVIMENTO E METODOLOGIA
% ========================================================================
